...
pub fn dashboard_page() -> Html {
    ...
    let columns = vec![
        Column {
            id: "type".to_string(),
            label: _i18n.t("dashboard.type").to_string(),
            render: None,
            sortable: true,
        },
        Column {
            id: "description".to_string(),
            label: _i18n.t("dashboard.description").to_string(),
            render: None,
            sortable: true,
        },
        Column {
            id: "date".to_string(),
            label: _i18n.t("dashboard.date").to_string(),
            render: None,
            sortable: true,
        },
    ];
    ...
    html! {
        <div class="p-4 space-y-6">
            <h1 class="text-2xl font-bold mb-6">{_i18n.t("dashboard.page_title")}</h1>

            // Stats cards
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatsCard
                    title={_i18n.t("dashboard.total_users")}
                    value="3,721"
                    change={Some(format!("15% {}", _i18n.t("dashboard.increase")))}
                ...
                <StatsCard
                    title={_i18n.t("dashboard.revenue")}
                    value="$45,231"
                    change={Some(format!("12% {}", _i18n.t("dashboard.increase")))}
                    change_type={ChangeType::Positive}
                ...
                <StatsCard
                    title={_i18n.t("dashboard.active_users")}
                    value="2,315"
                    change={Some(format!("321 {}", _i18n.t("dashboard.users_this_month")))}
                ...
                <StatsCard
                    title={_i18n.t("dashboard.conversion_rate")}
                    value="3.24%"
                    change={Some(format!("4% {}", _i18n.t("dashboard.decrease")))}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
                <Chart
                    title={_i18n.t("dashboard.performance_overview")}
            ...
            <div class="mt-6">
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
                        <h2 class="card-title">{_i18n.t("dashboard.recent_activity")}</h2>
                        <DataTable
                            columns={columns}
                            rows={rows}
                            hover={true}
